...
class AuctionManager:
    ...
    def create_auction_announcement(self, seller_private_key, seller_public_key,  item_description, reserve_price,
        duration_seconds, ring_public_keys):
        """Cria novo anuncio"""
    ...
    def submit_bid(self, auction_id, bidder_private_key, bidder_public_key, bid_amount, ring_public_keys):
        """Submete uma bid"""
    ...
    def close_bidding(self, auction_id):
