...
class Bid:
    ...
    def __init__(self, bid_id, auction_id, bid_commitment, bid_value, bid_nonce, timestamp, ring_signature):
        self.bid_id = bid_id
    ...
    @staticmethod
    def create(auction_id, bidder_private_key, bidder_public_key, bid_amount,ring_public_keys):
        """"Cria uma bid"""
