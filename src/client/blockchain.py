...
from crypto_utils import deserialize_key
import time
...
class Blockchain:
    ...
    def validate_transaction(self, transaction):
        ...
        # Prevenir replay attacks - verificar duplicação
        import json
        import hashlib
        ...
        if tx_type == 'USER_REGISTRATION':
            ...
            required_fields = ['auction_id', 'item_description', 'start_time', 'end_time', 'ring_signature']
    ...
    def add_block(self, block):
        ...
        # Adicionar transações do bloco ao set de vistas
        import json
        import hashlib
